...
8. **Identify Forces** - Surface constraints and pressures (security vs usability, speed vs cost) that affect design decisions for ARCHITECT to resolve
...
## 5b. Forces Identified
| Force | Description | Resolution Needed By |
|-------|-------------|----------------------|
| [e.g., Security vs Usability] | [Description] | ARCHITECT |
| [e.g., Speed vs Cost] | [Description] | ARCHITECT |
...
- **EXPERT-LISTENER** - SOURCE: Conducts domain discovery sessions, captures vocabulary and forces
- **ARCHITECT** - ENFORCER: Uses specifications and documented forces to design system architecture
...
**Forces Flow:**
```
EXPERT-LISTENER (Identify Forces) → CLARIFIER (Document Forces) → ARCHITECT (Resolve Forces)
```
